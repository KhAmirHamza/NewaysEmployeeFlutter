//import 'dart:io';GroupChatWidget _GroupChatWidgetState
import 'dart:convert';
import 'dart:io';
import 'dart:math';
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      String notifyMessageReceivedEvent =
          "notifyMessageReceived?convsType=Group";
...
class _ChatBubbleState extends State<ChatBubble> {
  @override
  Widget build(BuildContext context) {
    Message message = widget.convsController.conversations.firstWhere((element) => element.id==widget.convsId)
