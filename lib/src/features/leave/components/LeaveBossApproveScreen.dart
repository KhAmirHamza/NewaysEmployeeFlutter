...
import '../controllers/LeaveBossApproveController.dart';
import '../models/LeaveResponse.dart';
import '../widgets/getStatus.dart';
import 'package:neways3/src/utils/constants.dart';
import 'package:neways3/src/utils/functions.dart';

class LeaveBossApproveScreen extends StatelessWidget {
  const LeaveBossApproveScreen({super.key});
  ...
  Widget body() {
    return GetBuilder<LeaveBossApproveController>(
      init: LeaveBossApproveController(),
